...
export const demoAccounts: Record<UserRole, AuthUser & { password: string }> = {
  ...
  administrator: { id: "demo-rachel-morgan", name: "Rachel Morgan", email: "rachel.morgan@demo.kc", password: "Welcome123!", initials: "RM", role: "administrator", roleLabel: "Administrator", scope: "Global EHS&S administration" },
};
