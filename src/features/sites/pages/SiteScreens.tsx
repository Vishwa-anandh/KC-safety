  ...
  return (
    <div className="page-container">
      ...
      <div className="metrics-grid">
        ...
        <MetricCard label="Current self-assessed performance level" value={<span className="metric-with-badge"><PerformanceBadge performance={overallPerformance} /></span>} detail="Lowest roll-up across assessed sections" icon={<BarChart3 size={21} />} tone={overallPerformance === "performing" ? "success" : "danger"} />
  ...
  return (
    <div className="page-container">
      ...
      <div className="assessment-summary-strip">
        ...
        <div><PerformanceBadge performance={overallPerformance} /><span>Current self-assessed performance level</span></div>
