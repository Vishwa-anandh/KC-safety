...
export const appPaths = {
  ...
  adminRequirementAudit: "/admin/audit-log",
  settings: "/settings",
...
export const routeManifest: readonly AppRouteDefinition[] = [
  ...
  { id: "admin-requirement-audit", path: appPaths.adminRequirementAudit, access: { kind: "role", roles: administrator }, navigation: true },
